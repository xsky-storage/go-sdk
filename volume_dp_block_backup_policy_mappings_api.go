...
/* VolumeDpBlockBackupPolicyMappingsApiService 
 List volume dp block backup policy mapping
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "blockVolumeId" (int64) show mappings of specific block volume
     @param "dpBlockBackupPolicyId" (int64) show mappings of specific block volume
 @return VolumeDpBlockBackupPolicyMappingsResp*/
func (a *VolumeDpBlockBackupPolicyMappingsApiService) ListVolumeDpBlockBackupPolicyMappings(ctx context.Context, localVarOptionals map[string]interface{}) (VolumeDpBlockBackupPolicyMappingsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  VolumeDpBlockBackupPolicyMappingsResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/volume-dp-block-backup-policy-mappings/"
