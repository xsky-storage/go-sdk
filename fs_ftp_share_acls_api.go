...
type FsFtpShareAclsApiService service


/* FsFtpShareAclsApiService 
 List fs ftp share acls
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "limit" (int64) paging param
     @param "offset" (int64) paging param
     @param "fsFtpShareId" (int64) fs ftp share id
     @param "q" (string) query param of search
     @param "sort" (string) sort param of search
 @return FsftpShareAcLsResp*/
func (a *FsFtpShareAclsApiService) ListFSFTPShareACLs(ctx context.Context, localVarOptionals map[string]interface{}) (FsftpShareAcLsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  FsftpShareAcLsResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fs-ftp-share-acls/"
	...
	if err := typeCheckParameter(localVarOptionals["fsFtpShareId"], "int64", "fsFtpShareId"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["fsFtpShareId"].(int64); localVarOk {
		localVarQueryParams.Add("fs_ftp_share_id", parameterToString(localVarTempParam, ""))
	}
