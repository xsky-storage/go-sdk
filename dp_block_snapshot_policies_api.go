...
/* DpBlockSnapshotPoliciesApiService 
 Create dp block snapshot policy
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param body policy info
 @return DpBlockSnapshotPolicyResp*/
func (a *DpBlockSnapshotPoliciesApiService) CreateDpBlockSnapshotPolicy(ctx context.Context, body DpBlockSnapshotPolicyCreateReq) (DpBlockSnapshotPolicyResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpBlockSnapshotPolicyResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-block-snapshot-policies/"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return DpBlockSnapshotPolicyResp*/
func (a *DpBlockSnapshotPoliciesApiService) DeleteDpBlockSnapshotPolicy(ctx context.Context, policyId int64, localVarOptionals map[string]interface{}) (DpBlockSnapshotPolicyResp,  *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-block-snapshot-policies/{policy_id}"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param policyId resource id
 @return DpBlockSnapshotPolicyResp*/
func (a *DpBlockSnapshotPoliciesApiService) GetDpBlockSnapshotPolicy(ctx context.Context, policyId int64) (DpBlockSnapshotPolicyResp,  *http.Response, error) {
	var (
...
func (a *DpBlockSnapshotPoliciesApiService) ListDpBlockSnapshotPolicies(ctx context.Context, localVarOptionals map[string]interface{}) (DpBlockSnapshotPoliciesResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpBlockSnapshotPoliciesResp
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param body policy info
 @return DpBlockSnapshotPolicyResp*/
func (a *DpBlockSnapshotPoliciesApiService) UpdateDpBlockSnapshotPolicy(ctx context.Context, policyId int64, body DpBlockSnapshotPolicyUpdateReq) (DpBlockSnapshotPolicyResp,  *http.Response, error) {
	var (
