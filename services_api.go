 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return ServiceResp*/
func (a *ServicesApiService) GetService(ctx context.Context, serviceId int64) (ServiceResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ServiceResp
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "type_" (string) service type
 @return ServicesResp*/
func (a *ServicesApiService) ListServices(ctx context.Context, localVarOptionals map[string]interface{}) (ServicesResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ServicesResp
	)
