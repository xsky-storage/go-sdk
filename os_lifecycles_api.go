...
/* OsLifecyclesApiService 
 Get object storage lifecycle
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param lifecycleId lifecycle id
 @return ObjectStorageLifecycleResp*/
func (a *OsLifecyclesApiService) GetLifecycle(ctx context.Context, lifecycleId int64) (ObjectStorageLifecycleResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ObjectStorageLifecycleResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/os-lifecycles/{lifecycle_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"lifecycle_id"+"}", fmt.Sprintf("%v", lifecycleId), -1)
...
func (a *OsLifecyclesApiService) ListLifecycles(ctx context.Context, localVarOptionals map[string]interface{}) (ObjectStorageLifecyclesResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ObjectStorageLifecyclesResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/os-lifecycles/"
