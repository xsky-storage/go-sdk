...
type FsNfsShareAclsApiService service


/* FsNfsShareAclsApiService 
 List fs nfs shares acls
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "limit" (int64) paging param
     @param "offset" (int64) paging param
     @param "fsNfsShareId" (int64) fs nfs shares id
     @param "q" (string) query param of search
     @param "sort" (string) sort param of search
 @return FsnfsShareAcLsResp*/
func (a *FsNfsShareAclsApiService) ListFSNFSShareACLs(ctx context.Context, localVarOptionals map[string]interface{}) (FsnfsShareAcLsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  FsnfsShareAcLsResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fs-nfs-share-acls/"
