 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "dpBlockSnapshotPolicyId" (int64) dp block snapshot policy
 @return DpBlockSnapshotJobsResp*/
func (a *DpBlockSnapshotJobsApiService) ListDpBlockSnapshotJobs(ctx context.Context, localVarOptionals map[string]interface{}) (DpBlockSnapshotJobsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpBlockSnapshotJobsResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-block-snapshot-jobs/"
	...
	if err := typeCheckParameter(localVarOptionals["dpBlockSnapshotPolicyId"], "int64", "dpBlockSnapshotPolicyId"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["dpBlockSnapshotPolicyId"].(int64); localVarOk {
		localVarQueryParams.Add("dp_block_snapshot_policy_id", parameterToString(localVarTempParam, ""))
	}
