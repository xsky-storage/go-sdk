...
/* PartitionsApiService 
 Get a partition info
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param partitionId partition id
 @return PartitionResp*/
func (a *PartitionsApiService) GetPartition(ctx context.Context, partitionId string) (PartitionResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  PartitionResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/partitions/{partition_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"partition_id"+"}", fmt.Sprintf("%v", partitionId), -1)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "diskId" (int64) disk id
 @return PartitionsResp*/
func (a *PartitionsApiService) ListPartitions(ctx context.Context, localVarOptionals map[string]interface{}) (PartitionsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  PartitionsResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/partitions/"
	...
	if err := typeCheckParameter(localVarOptionals["diskId"], "int64", "diskId"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["diskId"].(int64); localVarOk {
		localVarQueryParams.Add("disk_id", parameterToString(localVarTempParam, ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{ "application/json",  }
