 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return TrashResp*/
func (a *TrashesApiService) CleanupTrash(ctx context.Context, trashId int64) (TrashResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  TrashResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/trashes/{trash_id}:cleanup"
	localVarPath = strings.Replace(localVarPath, "{"+"trash_id"+"}", fmt.Sprintf("%v", trashId), -1)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param trashId trash id
 @return TrashResp*/
func (a *TrashesApiService) GetTrash(ctx context.Context, trashId int64) (TrashResp,  *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/trashes/{trash_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"trash_id"+"}", fmt.Sprintf("%v", trashId), -1)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "type_" (string) the type of trash
     @param "q" (string) query param of search
     @param "sort" (string) sort param of search
 @return TrashesResp*/
func (a *TrashesApiService) ListTrashes(ctx context.Context, localVarOptionals map[string]interface{}) (TrashesResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  TrashesResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/trashes/"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param trashId trash id
 @param body trash info
 @return TrashResp*/
func (a *TrashesApiService) UpdateTrash(ctx context.Context, trashId int64, body TrashUpdateReq) (TrashResp,  *http.Response, error) {
	var (
