...
type FsGatewaysApiService service


/* FsGatewaysApiService 
 Get file storage gateway
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param fsGatewayId gateway id
 @return FsGatewayResp*/
func (a *FsGatewaysApiService) GetFSGateway(ctx context.Context, fsGatewayId int64) (FsGatewayResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  FsGatewayResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fs-gateways/{fs_gateway_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"fs_gateway_id"+"}", fmt.Sprintf("%v", fsGatewayId), -1)
...
func (a *FsGatewaysApiService) ListFSGateways(ctx context.Context, localVarOptionals map[string]interface{}) (FsGatewaysResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  FsGatewaysResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fs-gateways/"
