...
/* DpBlockBackupPoliciesApiService 
 Create dp block backup policy
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param body policy info
 @return DpBlockBackupPolicyResp*/
func (a *DpBlockBackupPoliciesApiService) CreateDpBlockBackupPolicy(ctx context.Context, body DpBlockBackupPolicyCreateReq) (DpBlockBackupPolicyResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpBlockBackupPolicyResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-block-backup-policies/"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return DpBlockBackupPolicyResp*/
func (a *DpBlockBackupPoliciesApiService) DeleteDpBlockBackupPolicy(ctx context.Context, policyId int64, localVarOptionals map[string]interface{}) (DpBlockBackupPolicyResp,  *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-block-backup-policies/{policy_id}"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param policyId resource id
 @return DpBlockBackupPolicyResp*/
func (a *DpBlockBackupPoliciesApiService) GetDpBlockBackupPolicy(ctx context.Context, policyId int64) (DpBlockBackupPolicyResp,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "blockVolumeId" (int64) show dp block backup policies of specific block volume
 @return DpBlockBackupPoliciesResp*/
func (a *DpBlockBackupPoliciesApiService) ListDpBlockBackupPolicies(ctx context.Context, localVarOptionals map[string]interface{}) (DpBlockBackupPoliciesResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpBlockBackupPoliciesResp
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param body policy info
 @return DpBlockBackupPolicyResp*/
func (a *DpBlockBackupPoliciesApiService) UpdateDpBlockBackupPolicy(ctx context.Context, policyId int64, body DpBlockBackupPolicyUpdateReq) (DpBlockBackupPolicyResp,  *http.Response, error) {
	var (
