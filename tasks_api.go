 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return TaskResp*/
func (a *TasksApiService) GetTask(ctx context.Context, taskId int64) (TaskResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  TaskResp
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "type_" (string) task type
     @param "hostId" (int64) host running the task
 @return TasksResp*/
func (a *TasksApiService) ListTasks(ctx context.Context, localVarOptionals map[string]interface{}) (TasksResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  TasksResp
	)
