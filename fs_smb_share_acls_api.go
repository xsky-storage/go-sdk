...
type FsSmbShareAclsApiService service


/* FsSmbShareAclsApiService 
 List fs smb share acls
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "limit" (int64) paging param
     @param "offset" (int64) paging param
     @param "fsSmbShareId" (int64) fs smb share id
     @param "q" (string) query param of search
     @param "sort" (string) sort param of search
 @return FssmbShareAcLsResp*/
func (a *FsSmbShareAclsApiService) ListFSSMBShareACLs(ctx context.Context, localVarOptionals map[string]interface{}) (FssmbShareAcLsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  FssmbShareAcLsResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fs-smb-share-acls/"
	...
	if err := typeCheckParameter(localVarOptionals["fsSmbShareId"], "int64", "fsSmbShareId"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["fsSmbShareId"].(int64); localVarOk {
		localVarQueryParams.Add("fs_smb_share_id", parameterToString(localVarTempParam, ""))
	}
