...
/* DpBlockSnapshotRecoveryJobsApiService 
 Create a dp block snapshot recovery job
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param body resource info
 @return DpBlockSnapshotRecoveryJobResp*/
func (a *DpBlockSnapshotRecoveryJobsApiService) CreateDpBlockSnapshotRecoveryJob(ctx context.Context, body DpBlockSnapshotRecoveryJobCreateReq) (DpBlockSnapshotRecoveryJobResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpBlockSnapshotRecoveryJobResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-block-snapshot-recovery-jobs/"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *DpBlockSnapshotRecoveryJobsApiService) DeleteDpBlockSnapshotRecoveryJob(ctx context.Context, jobId int64) ( *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-block-snapshot-recovery-jobs/{job_id}"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param jobId resource id
 @return DpBlockSnapshotRecoveryJobResp*/
func (a *DpBlockSnapshotRecoveryJobsApiService) GetDpBlockSnapshotRecoveryJob(ctx context.Context, jobId int64) (DpBlockSnapshotRecoveryJobResp,  *http.Response, error) {
	var (
...
func (a *DpBlockSnapshotRecoveryJobsApiService) ListDpBlockSnapshotRecoveryJobs(ctx context.Context, localVarOptionals map[string]interface{}) (DpBlockSnapshotRecoveryJobsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpBlockSnapshotRecoveryJobsResp
	)
