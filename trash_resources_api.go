...
/* TrashResourcesApiService 
 Delete trash resource
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param trashResourceId trash resource id
 @return TrashResourceResp*/
func (a *TrashResourcesApiService) DeleteTrashResource(ctx context.Context, trashResourceId int64) (TrashResourceResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  TrashResourceResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/trash-resources/{trash_resource_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"trash_resource_id"+"}", fmt.Sprintf("%v", trashResourceId), -1)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param trashResourceId trash resource id
 @return TrashResourceResp*/
func (a *TrashResourcesApiService) GetTrashResource(ctx context.Context, trashResourceId int64) (TrashResourceResp,  *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     ...
     @param "type_" (string) the type of trash resources
     @param "q" (string) query param of search
     @param "sort" (string) sort param of search
 @return TrashResourcesResp*/
func (a *TrashResourcesApiService) ListTrashResources(ctx context.Context, localVarOptionals map[string]interface{}) (TrashResourcesResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  TrashResourcesResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/trash-resources/"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param trashResourceId trash resource id
 @return TrashResourceResp*/
func (a *TrashResourcesApiService) RestoreTrashResource(ctx context.Context, trashResourceId int64) (TrashResourceResp,  *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/trash-resources/{trash_resource_id}:restore"
	localVarPath = strings.Replace(localVarPath, "{"+"trash_resource_id"+"}", fmt.Sprintf("%v", trashResourceId), -1)
