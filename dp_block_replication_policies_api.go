...
/* DpBlockReplicationPoliciesApiService 
 Create dp block replication policy
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param body policy info
 @return DpBlockReplicationPolicyResp*/
func (a *DpBlockReplicationPoliciesApiService) CreateDpBlockReplicationPolicy(ctx context.Context, body DpBlockReplicationPolicyCreateReq) (DpBlockReplicationPolicyResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpBlockReplicationPolicyResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-block-replication-policies/"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *DpBlockReplicationPoliciesApiService) DeleteDpBlockReplicationPolicy(ctx context.Context, policyId int64) ( *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-block-replication-policies/{policy_id}"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return DpBlockReplicationPolicyResp*/
func (a *DpBlockReplicationPoliciesApiService) GetDpBlockReplicationPolicy(ctx context.Context, policyId int64) (DpBlockReplicationPolicyResp,  *http.Response, error) {
	var (
...
func (a *DpBlockReplicationPoliciesApiService) ListDpBlockReplicationPolicies(ctx context.Context, localVarOptionals map[string]interface{}) (DpBlockReplicationPoliciesResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpBlockReplicationPoliciesResp
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param body policy info
 @return DpBlockReplicationPolicyResp*/
func (a *DpBlockReplicationPoliciesApiService) UpdateDpBlockReplicationPolicy(ctx context.Context, policyId int64, body DpBlockReplicationPolicyUpdateReq) (DpBlockReplicationPolicyResp,  *http.Response, error) {
	var (
