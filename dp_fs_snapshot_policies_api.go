...
type DpFsSnapshotPoliciesApiService service


/* DpFsSnapshotPoliciesApiService 
 Create dp fs snapshot policy
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param body policy info
 @return DpFsSnapshotPolicyResp*/
func (a *DpFsSnapshotPoliciesApiService) CreateDpFSSnapshotPolicy(ctx context.Context, body DpFsSnapshotPolicyCreateReq) (DpFsSnapshotPolicyResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpFsSnapshotPolicyResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-fs-snapshot-policies/"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return DpFsSnapshotPolicyResp*/
func (a *DpFsSnapshotPoliciesApiService) DeleteDpFSSnapshotPolicy(ctx context.Context, policyId int64, localVarOptionals map[string]interface{}) (DpFsSnapshotPolicyResp,  *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-fs-snapshot-policies/{policy_id}"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param policyId resource id
 @return DpFsSnapshotPolicyResp*/
func (a *DpFsSnapshotPoliciesApiService) GetDpFSSnapshotPolicy(ctx context.Context, policyId int64) (DpFsSnapshotPolicyResp,  *http.Response, error) {
	var (
...
func (a *DpFsSnapshotPoliciesApiService) ListDpFSSnapshotPolicies(ctx context.Context, localVarOptionals map[string]interface{}) (DpFsSnapshotPoliciesResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpFsSnapshotPoliciesResp
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param body policy info
 @return DpFsSnapshotPolicyResp*/
func (a *DpFsSnapshotPoliciesApiService) UpdateDpFSSnapshotPolicy(ctx context.Context, policyId int64, body DpFsSnapshotPolicyUpdateReq) (DpFsSnapshotPolicyResp,  *http.Response, error) {
	var (
