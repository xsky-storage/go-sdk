...
type FsNfsConnectionsApiService service


/* FsNfsConnectionsApiService 
 List fs nfs connections
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "limit" (int64) paging param
     @param "offset" (int64) paging param
     @param "fsNfsShareId" (int64) fs nfs id
     @param "q" (string) query param of search
     @param "sort" (string) sort param of search
 @return FsnfsConnectionsResp*/
func (a *FsNfsConnectionsApiService) ListFSNFSConnections(ctx context.Context, localVarOptionals map[string]interface{}) (FsnfsConnectionsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  FsnfsConnectionsResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fs-nfs-connections/"
	...
	if err := typeCheckParameter(localVarOptionals["fsNfsShareId"], "int64", "fsNfsShareId"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["fsNfsShareId"].(int64); localVarOk {
		localVarQueryParams.Add("fs_nfs_share_id", parameterToString(localVarTempParam, ""))
	}
