...
type FsFtpSessionsApiService service


/* FsFtpSessionsApiService 
...
func (a *FsFtpSessionsApiService) ListFSFTPSessions(ctx context.Context, localVarOptionals map[string]interface{}) (FsftpSessionsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  FsftpSessionsResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fs-ftp-sessions/"
