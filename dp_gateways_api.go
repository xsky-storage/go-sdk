...
/* DpGatewaysApiService 
 Create a dp gateway
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param body dp gateway info
 @return DpGatewayResp*/
func (a *DpGatewaysApiService) CreateDpGateway(ctx context.Context, body DpGatewayCreateReq) (DpGatewayResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpGatewayResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-gateways/"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return DpGatewayResp*/
func (a *DpGatewaysApiService) DeleteDpGateway(ctx context.Context, gatewayId int64) (DpGatewayResp,  *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/dp-gateways/{gateway_id}"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param gatewayId dp gateway id
 @return DpGatewayResp*/
func (a *DpGatewaysApiService) GetDpGateway(ctx context.Context, gatewayId int64) (DpGatewayResp,  *http.Response, error) {
	var (
...
func (a *DpGatewaysApiService) ListDpGateways(ctx context.Context, localVarOptionals map[string]interface{}) (DpGatewaysResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  DpGatewaysResp
	)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param body dp gateway info
 @return DpGatewayResp*/
func (a *DpGatewaysApiService) UpdateDpGateway(ctx context.Context, gatewayId int64, body DpGatewayUpdateReq) (DpGatewayResp,  *http.Response, error) {
	var (
