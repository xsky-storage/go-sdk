...
/* ProtectionDomainsApiService 
 get protection domain
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param protectionDomainId protection domain id
 @return ProtectionDomainRecordResp*/
func (a *ProtectionDomainsApiService) GetProtectionDomain(ctx context.Context, protectionDomainId int64) (ProtectionDomainRecordResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ProtectionDomainRecordResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/protection-domains/{protection_domain_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"protection_domain_id"+"}", fmt.Sprintf("%v", protectionDomainId), -1)
...
func (a *ProtectionDomainsApiService) ListProtectionDomains(ctx context.Context, localVarOptionals map[string]interface{}) (ProtectionDomainRecordsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  ProtectionDomainRecordsResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/protection-domains/"
