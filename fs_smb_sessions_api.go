...
type FsSmbSessionsApiService service


/* FsSmbSessionsApiService 
 List fs smb sessions
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "limit" (int64) paging param
     @param "offset" (int64) paging param
     @param "fsSmbShareId" (int64) fs smb id
     @param "q" (string) query param of search
     @param "sort" (string) sort param of search
 @return FssmbSessionsResp*/
func (a *FsSmbSessionsApiService) ListFSSMBSessions(ctx context.Context, localVarOptionals map[string]interface{}) (FssmbSessionsResp,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
		localVarFileBytes []byte
	 	successPayload  FssmbSessionsResp
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/fs-smb-sessions/"
